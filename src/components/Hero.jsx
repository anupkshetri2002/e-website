...
const Hero = () => {
  return (
    ...
    <div className='flex justify-center items-center'>
      <p className='md:tex-5xl sm:text-4xl text-xl font-bold'>Abhijan also Known hentai is</p>
      <Typed  className='md:tex-5xl sm:text-4xl text-xl font-bold pl-2' strings={['Gay' , 'Girl', 'PadGirl']} typeSpeed={120} backspped={140} loop />
    </div>
